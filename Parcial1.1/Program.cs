internal class Program
{
    private static void Main(string[] args)
    {
        ...
        if (SumaVentas >= 1000000)
        {
            ...
            Console.Write($"¡Felicidades! cumpliste con la meta mensual de ventas, has ganado un beneficio económico adicional de $ {100000:C0}");
        }
        else
        {
            TotalPago = SueldoNetoMes;
            Console.Write($"¡Ups! no cumpliste con la meta mensual de ventas este mes, no ganaste el beneficio.");
        }
